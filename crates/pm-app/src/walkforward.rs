...
pub struct WalkForwardConfig {
    ...
    pub br2_tail_buy_no_reversal_coverage_frac: f32,
    pub br2_tail_buy_no_reversal_min_seconds_to_close: f32,
    pub br2_tail_buy_no_reversal_max_seconds_to_close: f32,
    pub br2_tail_buy_no_reversal_min_favourite_ask: f32,
...
impl Default for WalkForwardConfig {
    fn default() -> Self {
        Self {
            ...
            br2_tail_buy_no_reversal_coverage_frac: 0.00,
            br2_tail_buy_no_reversal_min_seconds_to_close: 10.0,
            br2_tail_buy_no_reversal_max_seconds_to_close: 35.0,
            br2_tail_buy_no_reversal_min_favourite_ask: 0.895,
    ...
    let (report, bonereaper_v2_gate_stats) = match strat {
        ...
        StratId::BonereaperV2 => {
            let mut s = BonereaperV2::new(BonereaperV2Config {
                ...
                tail_buy_no_reversal_coverage_frac: cfg.br2_tail_buy_no_reversal_coverage_frac,
                tail_buy_no_reversal_min_seconds_to_close: cfg
                    .br2_tail_buy_no_reversal_min_seconds_to_close,
                tail_buy_no_reversal_max_seconds_to_close: cfg
                    .br2_tail_buy_no_reversal_max_seconds_to_close,
                tail_buy_no_reversal_min_favourite_ask: cfg
...
fn summary_run_config(cfg: &WalkForwardConfig) -> SummaryRunConfig {
    SummaryRunConfig {
        ...
        br2_tail_target_favourite_loss_coverage_frac: cfg
            .br2_tail_target_favourite_loss_coverage_frac,
        br2_tail_buy_no_reversal_coverage_frac: cfg.br2_tail_buy_no_reversal_coverage_frac,
        br2_tail_buy_no_reversal_min_seconds_to_close: cfg
            .br2_tail_buy_no_reversal_min_seconds_to_close,
        br2_tail_buy_no_reversal_max_seconds_to_close: cfg
            .br2_tail_buy_no_reversal_max_seconds_to_close,
        br2_tail_buy_no_reversal_min_favourite_ask: cfg.br2_tail_buy_no_reversal_min_favourite_ask,
